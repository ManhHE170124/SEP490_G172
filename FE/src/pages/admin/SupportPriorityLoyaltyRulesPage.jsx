...
import "../../styles/SupportPriorityLoyaltyRulesPage.css"; // tái dùng CSS card/table hiện có
...
function RuleModal({
    ...
    const [form, setForm] = React.useState({
        minTotalSpend: "",
        priorityLevel: "",
        isActive: false, // ❗ Mặc định tạo mới: TẮT
    });
        ...
        if (open) {
            const base =
                initial ||
                {
                    minTotalSpend: "",
                    priorityLevel: "",
                    isActive: false, // ❗ tạo mới: auto tắt
                };
    ...
    const validate = () => {
        ...
        if (!spendRaw) {
            ...
            e.minTotalSpend = "Tổng chi tiêu tối thiểu phải lớn hơn hoặc bằng 0.";
        }
                    ...
                    <div className="cat-modal-body input-group">
                        ...
                        <div className="row" style={{ gap: 16 }}>
                            <div className="group" style={{ flex: 1 }}>
                                ...
                                />
                                {/* Bỏ dòng mô tả để đỡ lệch layout */}
...
export default function SupportPriorityLoyaltyRulesPage() {
    ...
    return (
        <>
            <div className="page">
                {/* ===== Khối: Support Priority Loyalty Rules ===== */}
                <div className="card">
                    <div
                        style={{
                            display: "flex",
                    ...
                    >
                        <div className="group" style={{ width: 220 }}>
                            ...
                            >
                                ...
                                {/* ❗ Không lọc level 0 nữa, vì không có rule level 0 */}
                                <option value="1">Priority (1)</option>
                                <option value="2">VIP (2)</option>
                            </select>
                        </div>
