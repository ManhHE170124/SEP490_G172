    ...
    <div className="tkd-page">
      <div className="ticket-header">
        ...
        <div className="right">
          ...
          <button
            className={`btn warning ${!hasEditPermission || !actions.canTransfer ? 'disabled' : ''}`}
            title={!hasEditPermission ? "Bạn không có quyền chuyển hỗ trợ ticket" : !actions.canTransfer ? "Không thể chuyển hỗ trợ ticket này" : "Chuyển hỗ trợ"}
            disabled={!hasEditPermission || !actions.canTransfer}
            onClick={() => {
              if (!hasEditPermission) {
                showError("Không có quyền", "Bạn không có quyền chuyển hỗ trợ ticket");
                return;
