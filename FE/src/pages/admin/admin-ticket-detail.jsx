...
/** ===== NEW: Badges dùng màu đồng bộ màn Ticket Management ===== */
...
export default function AdminTicketDetail() {
  ...
  const handleSendReply = async () => {
    ...
    try {
      ...
      alert(e?.response?.data?.message || e.message || "Gửi phản hồi thất bại. Vui lòng thử lại.");
    } finally {
      setSending(false);
    }
  };
    ...
    <div className="tkd-page">
      <div className="ticket-header">
        <div className="left">
          ...
          <div className="meta">
            {/* Header meta giữ nguyên chip cũ */}
        ...
        <div className="right">
          {actions.canAssign && (
            <button className="btn primary" onClick={() => setModal({ open: true, mode: "assign", excludeUserId: null })}>
              Gán
            </button>
          )}
          {actions.canTransfer && (
            <button
              ...
              onClick={() => setModal({ open: true, mode: "transfer", excludeUserId: data.assigneeId })}
            >
              Chuyển hỗ trợ
            </button>
          )}
              ...
              <div className="reply-quick">
                ...
                <div className="reply-quick-buttons">
                  ...
                  <button
                    ...
                    className="chip-btn"
                    onClick={() =>
                      handleQuickInsert("Hiện tại em đang kiểm tra lại thông tin đơn hàng và key kích hoạt cho anh/chị.")
                    }
                  >
                    Đang kiểm tra
                  </button>
        ...
        <div className="right-col">
            ...
            {data.assigneeName || data.assigneeEmail ? (
              <>
                <div className="kv">
                  ...
                  <span className="v">{MAP_ASN[data.assignmentState] || data.assignmentState}</span>
                </div>
                <div className="kv">
            ...
            {latestOrder && (
              <>
                ...
                <div className="kv">
                  ...
                  <span className="v">{fmtDateTime(latestOrder.createdAt)}</span>
                </div>
                <div className="kv">
                  <span className="k">Trạng thái</span>
          ...
          <div className="panel related">
            ...
            {(relatedTickets || []).length === 0 && (
              <div className="empty">Không có ticket nào khác của khách hàng này.</div>
            )}
              ...
              {(relatedTickets || []).map((t) => (
                <div key={t.ticketId} className="related-item">
                  <div className="ri-main">
                    ...
                    {/* CHANGED: dùng badge màu đồng bộ màn Ticket Management */}
                  ...
                  <div className="ri-actions">
                    <button className="btn xs ghost" onClick={() => nav(`/admin/tickets/${t.ticketId}`)}>
                      Chi tiết
                    </button>
                  </div>
                </div>
