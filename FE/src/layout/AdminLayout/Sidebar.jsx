...
const Sidebar = () => {
  ...
  // (optional) Nếu layout ngoài dùng grid, bạn có thể dùng class này để đổi width
  React.useEffect(() => {
  ...
  const renderNav = () => {
    ...
    if (isStorageStaff) {
      return (
        <>
          ...
          <Link
            className={`sb-item ${
              currentPage === "key-monitor" ? "active" : ""
            }`}
            to="/key-monitor"
          >
            <svg viewBox="0 0 24 24" fill="none">
    ...
    return (
      <>
        ...
        <Link
          className={`sb-item ${
            currentPage === "role-manage" ? "active" : ""
          }`}
          to="/role-manage"
        >
          <svg
        ...
        <Link
          className={`sb-item ${
            currentPage === "role-assign" ? "active" : ""
          }`}
          to="/role-assign"
        >
          <svg
        ...
        <Link
          className={`sb-item ${
            currentPage === "/admin/tickets" ? "active" : ""
          }`}
          to="/admin/tickets"
        >
          <svg viewBox="0 0 24 24" fill="none">
        ...
        <Link
          className={`sb-item ${
            currentPage === "admin-post-list" ? "active" : ""
          }`}
          to="/admin-post-list"
        >
          <svg
        ...
        <Link
          className={`sb-item ${
            currentPage === "post-create-edit" ? "active" : ""
          }`}
          to="/post-create-edit"
        >
          <svg viewBox="0 0 24 24" fill="none">
        ...
        <Link
          className={`sb-item ${
            currentPage === "tag-post-type-manage" ? "active" : ""
          }`}
  ...
  return (
    <aside
      className={`sb-sidebar ${isOpen ? "open" : "collapsed"}`}
    ...
    >
      <div className="sb-header">
        ...
        <button
          ...
          aria-label={isOpen ? "Ẩn menu điều hướng" : "Hiển thị menu điều hướng"}
        >
      ...
      {isOpen && <nav className="sb-nav">{renderNav()}</nav>}
    </aside>
  );
};
