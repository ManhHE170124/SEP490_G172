 -- Drop table if exists
  IF OBJECT_ID('ProductReports', 'U') IS NOT NULL
      DROP TABLE ProductReports;
  GO
  ...
  CREATE INDEX IX_ProductReports_Variant ON
  ProductReports(ProductVariantId);
  CREATE INDEX IX_ProductReports_CreatedAt ON ProductReports(CreatedAt
  DESC);
  GO