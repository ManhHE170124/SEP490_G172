...
namespace Keytietkiem.DTOs.Post
{
    ...
    /// <summary>
    /// DTO for creating static content (Policy, UserGuide, AboutUs)
    /// Has relaxed validation rules compared to regular posts
    /// </summary>
    public class CreateStaticContentDTO
    {
        [Required(ErrorMessage = "Tiêu đề không được để trống.")]
        [StringLength(250, MinimumLength = 1, ErrorMessage = "Tiêu đề phải có từ 1 đến 250 ký tự.")]
        public string Title { get; set; } = null!;
        
        [Required(ErrorMessage = "Slug không được để trống.")]
        [StringLength(250, MinimumLength = 1, ErrorMessage = "Slug phải có từ 1 đến 250 ký tự.")]
        [RegularExpression(@"^[a-z0-9-]+$", ErrorMessage = "Slug chỉ được chứa chữ thường, số và dấu gạch ngang.")]
        public string Slug { get; set; } = null!;
    ...
    /// <summary>
    /// DTO for updating static content (Policy, UserGuide, AboutUs)
    /// Has relaxed validation rules compared to regular posts
    /// </summary>
